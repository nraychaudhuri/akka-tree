...
ScalaJS.i.sjsr_RuntimeString$class__lastIndexOf__sjsr_RuntimeString__I__I = (function($$this, ch) {
  ...
  while ((i < len)) {
    var index = i;
    var x$2 = col.apply$mcII$sp__I__I(index);
...
/** @constructor */
ScalaJS.c.Lakkatree_AkkaTree$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Lakkatree_AkkaTree$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lakkatree_AkkaTree$.prototype.constructor = ScalaJS.c.Lakkatree_AkkaTree$;
/** @constructor */
ScalaJS.h.Lakkatree_AkkaTree$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lakkatree_AkkaTree$.prototype = ScalaJS.c.Lakkatree_AkkaTree$.prototype;
ScalaJS.c.Lakkatree_AkkaTree$.prototype.$$js$exported$meth$onMessage__sjs_js_Dictionary__O = (function(event) {
  return (this.onMessage__sjs_js_Dictionary__V(event), (void 0))
});
ScalaJS.c.Lakkatree_AkkaTree$.prototype.onMessage__sjs_js_Dictionary__V = (function(event) {
  var x = event["actorpath"];
  var this$2 = ScalaJS.m.s_Console();
  this$2.out__Ljava_io_PrintStream().println__O__V(x)
});
ScalaJS.c.Lakkatree_AkkaTree$.prototype["onMessage"] = (function(arg$1) {
  arg$1 = arg$1;
  return this.$$js$exported$meth$onMessage__sjs_js_Dictionary__O(arg$1)
});
ScalaJS.is.Lakkatree_AkkaTree$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lakkatree_AkkaTree$)))
});
ScalaJS.as.Lakkatree_AkkaTree$ = (function(obj) {
  return ((ScalaJS.is.Lakkatree_AkkaTree$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "akkatree.AkkaTree$"))
});
ScalaJS.isArrayOf.Lakkatree_AkkaTree$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lakkatree_AkkaTree$)))
});
ScalaJS.asArrayOf.Lakkatree_AkkaTree$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lakkatree_AkkaTree$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lakkatree.AkkaTree$;", depth))
});
ScalaJS.d.Lakkatree_AkkaTree$ = new ScalaJS.ClassTypeData({
  Lakkatree_AkkaTree$: 0
}, false, "akkatree.AkkaTree$", ScalaJS.d.O, {
  Lakkatree_AkkaTree$: 1,
  O: 1
});
ScalaJS.c.Lakkatree_AkkaTree$.prototype.$classData = ScalaJS.d.Lakkatree_AkkaTree$;
ScalaJS.n.Lakkatree_AkkaTree = (void 0);
ScalaJS.m.Lakkatree_AkkaTree = (function() {
  if ((!ScalaJS.n.Lakkatree_AkkaTree)) {
    ScalaJS.n.Lakkatree_AkkaTree = new ScalaJS.c.Lakkatree_AkkaTree$().init___()
  };
  return ScalaJS.n.Lakkatree_AkkaTree
});
ScalaJS.e["AkkaTree"] = ScalaJS.m.Lakkatree_AkkaTree;
/** @constructor */
...
ScalaJS.c.scm_WrappedArray.prototype.foreach__F1__V = (function(f) {
  ...
  while ((i < len)) {
    var index = i;
    f.apply__O__O(this.apply$mcII$sp__I__I(index));
    i = ((i + 1) | 0)
  }
});

...
trait Selection extends js.Array[js.Any] with Selectors {
  ...
  def style[A](name: String, valueFunction: js.Function2[A, Double, String]): Selection = js.native
  ...
  var append: js.ThisFunction1[js.Any, String, Selection] = js.native
  var insert: js.ThisFunction2[js.Any, String, String, Selection] = js.native
  var remove: js.ThisFunction0[js.Any, Selection] = js.native
  ...
  def data[A](values: js.Array[A])(key: js.Function2[A, Double, Any]): UpdateSelection = js.native
...
@JSExport
class GraphLinkForce{
  var source: GraphNodeForce = _
  var target: GraphNodeForce = _
}
